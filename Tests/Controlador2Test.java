...
class Controlador2Test {
    Controlador2 cont = new Controlador2();
    ...
    void procesos_negativos() {
        ...
        assertEquals(p1, cont.heap2.remove());
        assertEquals(p3, cont.heap2.remove());
        assertEquals(p2, cont.heap2.remove());
        assertEquals(p4, cont.heap2.remove());
    }
    ...
    void procesos_iguales() {
        ...
        assertEquals(p5, cont.heap2.remove());
        assertEquals(p2, cont.heap2.remove());
        assertEquals(p4, cont.heap2.remove());
        assertEquals(p3, cont.heap2.remove());
        assertEquals(p1, cont.heap2.remove());
